#include "hook/fst/options.h"

#include "util/options.h"

#define FSTHOOK_OPTIONS_STR_GAME_SETTINGS "game.settings"
#define FSTHOOK_OPTIONS_STR_PATCH_GFX_WINDOWED "patch.gfx.windowed"
...
const struct util_options_def fsthook_options_def[] = {
    {
        .name = FSTHOOK_OPTIONS_STR_GAME_SETTINGS,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_HOOK_MON_FS,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_HOOK_MON_IO,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_HOOK_MON_OPEN,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_HOOK_MON_USB,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_NET_PROFILE_MACHINE_ID,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_PIUIO_EXIT_TEST_SERV,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_SOUND_DEVICE,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_SIGSEGV_HALT_ON_SEGV,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_UTIL_LOG_FILE,
    ...
    {
        .name = FSTHOOK_OPTIONS_STR_PATCH_UTIL_LOG_LEVEL,
...
const struct util_options_defs fsthook_options_defs = {
    .usage_header =
        "Pumptools fsthook for Pump It Up: Fiesta, build " __DATE__ " " __TIME__ ", gitrev " STRINGIFY(GITREV) "\n"
        "Usage: LD_PRELOAD=./fsthook.so [game exec] [game data path] <options>",
    .usage_param = 'h',
    .defs = fsthook_options_def,
