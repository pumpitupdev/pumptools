#include "hook/fex/options.h"

#include "util/options.h"

#define FEXHOOK_OPTIONS_STR_GAME_SETTINGS "game.settings"
#define FEXHOOK_OPTIONS_STR_PATCH_GFX_WINDOWED "patch.gfx.windowed"
...
const struct util_options_def fexhook_options_def[] = {
    {
        .name = FEXHOOK_OPTIONS_STR_GAME_SETTINGS,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_GFX_WINDOWED,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_HOOK_MON_FS,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_HOOK_MON_IO,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_HOOK_MON_OPEN,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_HOOK_MON_USB,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_NET_PROFILE_MACHINE_ID,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_PIUIO_EXIT_TEST_SERV,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_SOUND_DEVICE,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_SIGSEGV_HALT_ON_SEGV,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_UTIL_LOG_FILE,
    ...
    {
        .name = FEXHOOK_OPTIONS_STR_PATCH_UTIL_LOG_LEVEL,
...
const struct util_options_defs fexhook_options_defs = {
    .usage_header =
        "Pumptools fexhook for Pump It Up: FiestaEX, build " __DATE__ " " __TIME__ ", gitrev " STRINGIFY(GITREV) "\n"
        "Usage: LD_PRELOAD=./fexhook.so [game exec] [game data path] <options>",
    .usage_param = 'h',
    .defs = fexhook_options_def,
