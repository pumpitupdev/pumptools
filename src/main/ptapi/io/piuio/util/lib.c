...
bool ptapi_io_piuio_util_lib_load(const char* path, struct ptapi_io_piuio_api* api)
{
    ...
    api->get_input_pad = (ptapi_io_piuio_get_input_pad_t)
        cnh_lib_get_func_addr_handle(handle, "ptapi_io_piuio_get_input_pad");
    api->get_input_sys = (ptapi_io_piuio_get_input_sys_t)
        cnh_lib_get_func_addr_handle(handle, "ptapi_io_piuio_get_input_sys");
    api->set_output_pad = (ptapi_io_piuio_set_output_pad_t)
        cnh_lib_get_func_addr_handle(handle, "ptapi_io_piuio_set_output_pad");
    api->set_output_cab = (ptapi_io_piuio_set_output_cab_t)
        cnh_lib_get_func_addr_handle(handle, "ptapi_io_piuio_set_output_cab");
