...
static const struct ptapi_io_x11_input_hook_handler
    _piuio_emu_keyboard_input_hook_handler = {
  ...
  if (player == 0) {
    inputs->lu = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P1_LU]];
    inputs->ru = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P1_RU]];
    inputs->cn = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P1_CN]];
    inputs->ld = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P1_LD]];
    inputs->rd = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P1_RD]];
  } else {
    inputs->lu = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P2_LU]];
    inputs->ru = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P2_RU]];
    inputs->cn = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P2_CN]];
    inputs->ld = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P2_LD]];
    inputs->rd = ptapi_io_piuio_keyboard_buffer
        [ptapi_io_piuio_keyboard_conf
             ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_P2_RD]];
  }
}
...
void ptapi_io_piuio_get_input_sys(struct ptapi_io_piuio_sys_inputs *inputs)
{
  inputs->test = ptapi_io_piuio_keyboard_buffer
      [ptapi_io_piuio_keyboard_conf
           ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_TEST]];
  inputs->service = ptapi_io_piuio_keyboard_buffer
      [ptapi_io_piuio_keyboard_conf
           ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_SERVICE]];
  inputs->clear = ptapi_io_piuio_keyboard_buffer
      [ptapi_io_piuio_keyboard_conf
           ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_CLEAR]];
  inputs->coin = ptapi_io_piuio_keyboard_buffer
      [ptapi_io_piuio_keyboard_conf
           ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_COIN]];
  inputs->coin2 = ptapi_io_piuio_keyboard_buffer
      [ptapi_io_piuio_keyboard_conf
           ->button_map[PTAPI_IO_PIUIO_KEYBOARD_UTIL_CONF_INPUT_COIN2]];
}
